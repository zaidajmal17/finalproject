...
import com.example.foodonlineapp.databinding.ActivityLoginBinding;
...
public class Login extends AppCompatActivity {
    com.example.foodonlineapp.databinding.ActivityLoginBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                progressDialog.show();
                auth.signInWithEmailAndPassword(binding.lgemail.getText().toString(),binding.lgpassword.getText().toString())
        ...
        binding.Noaccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Login.this,SignmeUp.class);
                startActivity(intent);
            }
        });
